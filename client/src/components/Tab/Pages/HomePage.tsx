  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-200">
      <div className="text-center">
        <h1 className="text-4xl font-bold mb-8">GymLAB</h1>
        <p className="text-lg text-gray-600 mb-8">Â¡Testea vos mismo tus ejercicios del gimnasio!</p>
        <button className="bg-black hover:bg-gray-800 text-white font-bold py-2 px-4 rounded mb-4">
          Comienza YA
        </button>
        <p className="text-lg text-gray-500 mb-8">O prueba uno de nuestros ejemplos</p>
